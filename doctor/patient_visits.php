...
// Get total visits
$total = $conn->query("SELECT COUNT(*) as total FROM visits WHERE doctor_id = $doctorId")->fetch_assoc()['total'];
...
<div class="container">
    <h2 class="text-center my-4">My Patient Visits</h2>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $visit['triage_status']; ?></td>
                            <td>
                            ...
                            <td>
                                <a href="record_notes.php?visit_id=<?php echo $visit['visit_id']; ?>" class="btn btn-sm btn-info">
